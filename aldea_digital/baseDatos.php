...
<html>
    ...
    <body>
        ...
        $conectar = new PDO("mysql:dbname=prueba;host:localhost","root","");
        ...
        $sentencia = $conectar->prepare("INSERT INTO informacion (nombre,email,telefono) VALUES (:nombreBase,:emailBase,:telefonoBase)");
